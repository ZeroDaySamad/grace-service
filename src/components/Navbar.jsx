...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white/90 backdrop-blur-xl border-t border-gray-100 z-[100] flex md:hidden items-center justify-around px-4 pb-safe shadow-[0_-1px_10px_rgba(0,0,0,0.02)]">
